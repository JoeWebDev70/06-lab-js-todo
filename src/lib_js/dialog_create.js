...
//create form
export const formTask = document.createElement("form");
...
export const inputTitle = document.createElement("input");
...
export const inputDate = document.createElement("input");
inputDate.type = "date";
...
export const txtareaDescription  = document.createElement("textarea");
